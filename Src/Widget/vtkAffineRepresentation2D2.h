/*=========================================================================
  ...
  Module:    vtkAffineRepresentation2D2.h
...
=========================================================================*/
/**
 * @class   vtkAffineRepresentation2D2
...
#ifndef __VTK_AFFINE_REPRESENTATION_2D_2_H__
#define __VTK_AFFINE_REPRESENTATION_2D_2_H__
...
class vtkActor2D;
class vtkMatrix4x4;
class vtkAffineRepresentation2D2Callback;


class  vtkAffineRepresentation2D2 : public vtkAffineRepresentation
{
public:
  /**
   * Instantiate this class.
   */
  static vtkAffineRepresentation2D2 *New();

  //@{
  /**
   * Standard methods for instances of this class.
   */
  vtkTypeMacro(vtkAffineRepresentation2D2,vtkAffineRepresentation);
  ...
  void SetOrientationToOrientationXZ() { this->SetOrientation(ORIENTATION_XZ); }
  void SetOrientationToOrientationYZ() { this->SetOrientation(ORIENTATION_YZ); }
  void SetOrientationToOrientationXY() { this->SetOrientation(ORIENTATION_XY); }
  ...
  //@{
  /**
   * Subclasses of vtkAffineRepresentation2D2 must implement these methods. These
  ...
  //@}
  // For External changing the UserMatrix.
  bool CallbackFlag;
protected:
  vtkAffineRepresentation2D2();
  ~vtkAffineRepresentation2D2();
  ...
  vtkMatrix4x4* TotalMatrix;
  vtkMatrix4x4* UserMatrix;
  vtkAffineRepresentation2D2Callback* AffineRepresentation2D2Callback;
...
private:
  vtkAffineRepresentation2D2(const vtkAffineRepresentation2D2&) VTK_DELETE_FUNCTION;
  void operator=(const vtkAffineRepresentation2D2&) VTK_DELETE_FUNCTION;
};
